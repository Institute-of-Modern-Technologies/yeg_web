        ...
        <div className="flex flex-col md:flex-row gap-16">
          <div className="md:w-1/2 lg:w-3/5">
            ...
            <p className="text-gray-600 mb-8">
              We&apos;d love to hear from you! Please fill out the form below with any questions or inquiries, and our team will get back to you as soon as possible.
            </p>
          ...
          <div className="md:w-1/2 lg:w-2/5">
            <div className="rounded-lg overflow-hidden shadow-md mb-8">
              <div className="relative h-72">
                <Image 
                  src="https://images.unsplash.com/photo-1583619086237-75a2cadd588f?q=80&w=800&auto=format"
            ...
            <div className="bg-gray-50 rounded-lg p-6 shadow-md">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-orange-500 mr-3 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@educationschool.edu</p>
                  </div>
                </div>
