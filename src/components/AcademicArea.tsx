    ...
    <section id="academics" className="py-16 px-6 bg-white relative z-10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <h2 className="text-3xl font-bold text-[#950713] mb-4 text-center">
          Why <span className='text-[#FF00FF]'>Young</span> <span className='text-[#FFFF00] bg-[#000000] px-1 sm:px-2 rounded-md'>Experts</span> <span className='text-[#00FFFF]'>Group</span> is the best Solution for Innovation
        </h2>
